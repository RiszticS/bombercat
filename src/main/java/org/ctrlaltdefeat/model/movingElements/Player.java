...
public class Player extends MovingElement implements KeyListener {
    ...
    public Player(CoordinatePosition p) {
        ...
        animationConfiguration.add(new AnimationConfiguration("/images/astronautwalkback.png", 9, 1, 9, 0, 32, 48, 2));
        animationConfiguration.add(new AnimationConfiguration("/images/astronautwalkright.png", 6, 1, 6, 0, 32, 48, 3));
        animationConfiguration.add(new AnimationConfiguration("/images/astronautwalkfront.png", 9, 1, 9, 0, 32, 48, 2));
        animationConfiguration.add(new AnimationConfiguration("/images/astronautwalkleft.png", 6, 1, 6, 0, 32, 48, 3));
        animationConfiguration.add(new AnimationConfiguration("/images/astronautidle.png", 13, 1, 13, 0, 32, 48, 3));
